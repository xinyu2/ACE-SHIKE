...
def main(args):
    ...
    if optim_state is not None:
        if (start_epoch - 1) >= args.cornerstone:
            optimizer_crt.load_state_dict(optim_state)
        else:
            optimizer_feat.load_state_dict(optim_state)    
    ...
    for epoch in range(start_epoch, args.epochs):  # args.start_epoch
        ...
        save_checkpoint(
            {
                ...
                'optimizer_state_dict': tmp_optimizer.state_dict(),
                'best_acc1': best_acc1,
